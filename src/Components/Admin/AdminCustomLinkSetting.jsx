...
const AdminCustomLinkSetting = () => {
  return (
    <>
      <div className="row">
        <div className="col">
          <button type="button" className="btn btn-white" data-bs-toggle="modal" data-bs-target="#exampleModal"><i className="fa fa-plus"></i> Add New Custom Link</button>
        </div>
      </div>
          ...
          <div className="card">
            <div class="s-b-inner s-b-notifications bg-white b-shadow-4 rounded">
              <div class="s-b-n-header" id="tabs">
                <h2 class="pt-3">Custom Link Settings</h2>
              </div><hr />
              <div class="">
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <h1 class="modal-title fs-5" id="exampleModalLabel">Add New Custom Link</h1>
                  ...
                  <form action="">
                    <div className="row">
                      <div className="col">
                        ...
                        <input type="text" name="" id="" className="form-control" placeholder='Link Title '/>
                      </div>
                      <div className="col">
                    ...
                    <div className="row mt-3">
                      <div className="col">
                        <label htmlFor="">Can Be Viewed B</label>
...
export default AdminCustomLinkSetting