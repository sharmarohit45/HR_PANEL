                        ...
                        <div className="page-head-box">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active" aria-current="page">Estimate-Invoice</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div className="card-body">
                                    <div className="row">
                                        ...
                                        <div className="col mt-5">
                                            <div className="invoice-details">
                                                <h3 className="text-uppercase"><b>Estimate</b></h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
                                        ...
                                        <div className="col-sm-4">
                                            <table className='table table-bordered' style={{ fontSize: 'smaller', textAlign: 'start' }}>
                                                <tbody>
                                                    <tr>
                                                        <th style={{ backgroundColor: '#f1f1f3' }}>Estimate Number</th>
                                                        <td>#EST-0001</td>
                                                    </tr>
                                                    <tr>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-sm-6 col-lg-5 col-xl-4 m-b-20">
                                            <div className="row">
                                                <div className="col">
                                                    <div className="row p-2 mt-5" style={{ border: '2px solid red', textAlign: 'center', color: 'green' }}>
                                                        <h4 className='text-danger'><b>Waiting</b></h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="col m-3">
                            <div className="input-group">
                                ...
                                <li><a className="dropdown-item" href="#"><i className='fa fa-edit'></i> Edit</a></li>
                                    ...
                                    <li><a className="dropdown-item" href="#"><i className='fa fa-times'></i> Cancel Estimate</a></li>
                            ...
                            <Link to="/admin/estimates"><button type="button" className='btn btn-white'>Cancel</button></Link>
                            </div> 
                        </div>
                    </div>
                </div>
...
export default AdminEstimateInvoice